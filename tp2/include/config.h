...
const std::string NOME_ARQUIVO_INDICE_HASH = BIN_DIR + "/tabela_hash.idx";
const std::string NOME_ARQUIVO_INDICE_PRIM = BIN_DIR + "/prim_index.idx";
const std::string NOME_ARQUIVO_INDICE_SEC = BIN_DIR + "/sec_index.idx";
